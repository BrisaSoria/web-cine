...
<body>
  ...
  <div class="container-fluid">
    <form action="buscar.php" method="post" class="d-flex" role="search" enctype="multipart/form-data">
    	
    	<br><br>
      <input class="form-control me-2" type="text" name="titulo" placeholder="ingrese titulo de la pelicula" aria-label="Search">
