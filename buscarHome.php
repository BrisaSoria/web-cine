	...
	<div class="container my-3">
		...
		<div class="alert alert-dark" role="alert">
		   <h2>Buscar Peliculas</h2>
				...
				<form action="buscarTitulo.php" method="post" class="row g-12" enctype="multipart/form-data">
				...
				<form action="buscarGenero.php" method="post" class="row g-12" enctype="multipart/form-data">
